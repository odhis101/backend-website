         ...
         // getting the value of the data
            ...
            if(isset($_FILES['image']['name'])){
                ...
                // get the extension of our image (jpg, png, gif, etc.. )e.g test.jpg
                    ...
                    // rename the image
                    $image_name = 'food-name'.rand(000,999).'.'.$ext; // eg. food_category_012 .jpg
            ...
            if($res== true){
                ...
                $_SESSION['upload']='<div class = "success">category added succesfully </div>';
                ...
                //create a variable to display a message
                $_SESSION['upload']='<div class = "error" ></div>Failed to add food please check all forms </div>';
